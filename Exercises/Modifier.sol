...
contract FunctionModifier {
    ...
    // Modifiers can take inputs. This modifier checks that tge address passed in is not the zero address
    ...
    // it is still executing. Is a mutex
    modifier noReentrancy() {
        require(!locked, "No reentrancy");

        locked = true;
        _;
        locked = false; //do after the body of function
    }
